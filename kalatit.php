...
//$sqlrest = "select * from tbl_rest where rest_id =";
...
?>
	<!-- SubHeader =============================================== -->
	<section class="parallax-window" data-parallax="scroll" data-image-src="img/kalatithback.jpg"
		data-natural-width="1400" data-natural-height="470">
		<div id="subheader">
			<div id="sub_content">
				<div id="thumb"><img src="img/kalatit.png" alt=""></div>

				<h1 style="font-family: Buxton Sketch; font-size: 50px; color:#f6ea3b; font-weight: 100;">Kalatit
					Restaurant
				</h1>
				<div style="font-size :20px; color: rgb(226, 111, 90); "><em>-Where Food Speaks With Your Delicious
						Plate-</em></div>
				<br><br>

				<div style="font-size :15px; color: blanchedalmond;"><i class="icon_pin"></i> Nr, DSP Bunglow Rd,
					Maheswari Nagar, Kadiawad, Jamnagar, Gujarat 361008</div>
		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<div class="dropdown dropdown-options">
						<?php 
						@$num=0;
						$sql = "select * from tbl_item where rest_Id =1 order by item_Id asc";
