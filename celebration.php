...
<head>
    ...
    <title>Eat Up!-celebration</title>
...
<!-- SubHeader =============================================== -->
<section class="parallax-window" data-parallax="scroll" data-image-src="img/celebrationback.jpg" data-natural-width="1400" data-natural-height="470">
	
	<div id="subheader">
		<div id="sub_content">
			<div id="thumb"><img src="img/celebrationn.jpg" alt=""></div>

			<h1 style="font-family: Buxton Sketch; font-size: 50px; color:#f3b814; font-weight: 100;">Hotel Celebration
			</h1>
			<div style="font-size :20px; color: rgb(255, 251, 198); "><em>-Quality,Comfort & Food-</em></div>
			<br><br>

			<div style="font-size :15px; color: blanchedalmond;"><i class="icon_pin"></i>Indira gandhi Marg,near GuruDwara Circle. Jamnagar. 361001.</div>
    ...
    <div id="position">
        <div class="container">
            <ul>
                ...
                <li><a href="detail_page.php">Restaurants</a></li>
                <li>Celebration Hotel</li>
            </ul>
            <!--<a href="list_page.php" class="search-overlay-menu-btn"><i class="icon-search-6"></i> -->
        </div>
    </div><!-- Position -->
		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<div class="dropdown dropdown-options">
						<?php 
						@$num=0;
						$sql = "select * from tbl_item where rest_Id =6 order by item_Id asc";
