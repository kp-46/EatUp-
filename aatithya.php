...
<![endif]-->
	...
	<section class="parallax-window" data-parallax="scroll" data-image-src="img/aatithyaback.jpg" data-natural-width="1400"
        data-natural-height="470">
        <div id="subheader">
            <div id="sub_content">
                <div id="thumb"><img src="img/aatithya.jpg" alt=""></div>

                <h1 style="font-family: Buxton Sketch; font-size: 50px; color:#dbd5cf; font-weight: 100;">Atithya Restaurant        </h1>
                <div style="font-size :20px; color: rgb(155, 118, 59); "><em>-Where Consistency & Quality Of Taste matters-</em></div>
                <br><br>

                <div style="font-size :15px; color: blanchedalmond;"><i class="icon_pin"></i>Walkeshwari Nagri, b/s Aadarsh Hospital,
					Jamnagar 361008.</div>
		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<div class="dropdown dropdown-options">
						<?php 
                        @$num=0;
						$sql = "select * from tbl_item where rest_Id =5 order by item_Id asc";
