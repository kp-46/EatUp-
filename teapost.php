...
<head>
    ...
    <meta name="keywords" content="pizza, delivery food, fast food, continental,sandwich,sizzler,pasta,coofee,shake,tea,lasagne, take away">
...
<![endif]-->
    ...
    <!-- SubHeader =============================================== -->
    <section class="parallax-window" data-parallax="scroll" data-image-src="img/Tea-Postbg.jpg"
        data-natural-width="1400" data-natural-height="470">
        <div id="subheader">
            <div id="sub_content">
                <div id="thumb"><img src="img/teapost.jpg" alt=""></div>

                <h1 style="font-family: Buxton Sketch; font-size: 50px; color:#1f8b28; font-weight: 100;">Tea Post</h1>
                <div style="font-size :20px; color: rgb(141, 226, 138); "><em>--A Place To Talk--</em></div>
                <br><br>
                
                <div style="font-size :15px; color: blanchedalmond;"><i class="icon_pin"></i>7, Main Road deep bhavan Patel Colony, Patel Colony, Jamnagar, Gujarat 361008</div>
                <div style="font-size :12px; color: blanchedalmond;"><strong>Delivery charge:</strong> &#8377 89 ,
                    <strong>free over:</strong> &#8377 599.</div>
    ...
    <div id="position">
        <div class="container">
            <ul>
                ...
                <li><a href="teapost.php">TeaPost</li>
            </ul>
		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<div class="dropdown dropdown-options">
						<?php 
                        @$num=0;
						$sql = "select * from tbl_item where rest_Id =3 order by item_Id asc";
        ...
        <div class="col-md-12">
            <div id="social_footer">
                         <ul>
                            ...
                            <li><a href="mailto:project211921@gmail.com"><i class="icon-google"></i></a></li>
