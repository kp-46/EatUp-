...
<![endif]-->
	...
	<!-- SubHeader =============================================== -->
	<section class="parallax-window" data-parallax="scroll" data-image-src="img/aaram.jpg" data-natural-width="1400"
		data-natural-height="470">


		<div id="subheader">
			<div id="sub_content">
				<div id="thumb"><img src="img/aaramlogo.png" alt=""></div>

				<h1 style="font-family: Buxton Sketch; font-size: 50px; color:white; font-weight: 100;">Aaram Hotel
				</h1>
				<div style="font-size :20px; color: rgb(245, 244, 233); "><em>-Elegance,Style & Comfort-</em></div>
				<br><br>

				<div style="font-size :15px; color: blanchedalmond;"><i class="icon_pin"></i> Nand Niwas , Pandit Nehru
					Marg, Jamnagar,
					Gujarat 361008</div>
		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<div class="dropdown dropdown-options">
						<?php 
                        @$num=0;
						$sql = "select * from tbl_item where rest_Id =4 order by item_Id asc";
