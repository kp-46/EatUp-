...
<!-- SubHeader =============================================== -->
<section class="parallax-window" data-parallax="scroll" data-image-src="img/domback.jpg" data-natural-width="1400"
        data-natural-height="470">
        <div id="subheader">
            <div id="sub_content">
                <div id="thumb"><img src="img/dominos.png" alt=""></div>

                <h1 style="font-family: Buxton Sketch; font-size: 50px; color:white; font-weight: 100;">Domino's
                </h1>
                <div style="font-size :18px; color:white; "><em>Pizzaaaaaaaa!<em></div>
                <br><br>

                <div style="font-size :15px; color: blanchedalmond;"><i class="icon_pin"></i>	1D, Ground Floor & First Floor, Cross, Bedi Rd, Paras Society, Jamnagar, Gujarat 361008</div>
                     <div style="font-size :12px; color: blanchedalmond;"><strong>Delivery charge:</strong> &#8377 59 ,
                             <strong>free over:</strong> &#8377 399.</div>
    ...
    <div id="position">
        <div class="container">
            <ul>
              ...
              <li><a href="dominos.php">Dominos</a></li>
            </ul>
		...
		<div class="row">
            ...
            <div class="col-md-9">
				...
				<div class="dropdown dropdown-options">
						<?php 
                        @$num=0;
						$sql = "select * from tbl_item where rest_Id =2 order by item_Id asc";
					...
					<tr>
						...
						<td><h5> <?php echo $disp['item_name'];?> Pizza</h5></td>
