...
<![endif]-->
    ...
    <!-- SubHeader =============================================== -->
    <section class="parallax-window" data-parallax="scroll" data-image-src="img/theismh.jpg" data-natural-width="1400"
        data-natural-height="470">
        <div id="subheader">
            <div id="sub_content">
                <div id="thumb"><img src="img/theismss.jpg" alt=""></div>

                <h1 style="font-family: Buxton Sketch; font-size: 50px; color:#1d0e02; font-weight: 100;">Theism Cafe
                </h1>
                <div style="font-size :18px; color:rgb(241, 235, 153); "><em>---Cafe---<em></div>
                <br><br>

                <div style="font-size :15px; color: blanchedalmond;"><i class="icon_pin"></i>Viriral bagh, Palace Rd,
                    Jamnagar, Gujarat 36100</div>
		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<div class="dropdown dropdown-options">
						<?php 
                        @$num=0;
						$sql = "select * from tbl_item where rest_Id =8 order by item_Id asc";
