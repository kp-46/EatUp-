...
<!-- SubHeader =============================================== -->
<section class="parallax-window" data-parallax="scroll" data-image-src="img/subway.jpg" data-natural-width="1400"
        data-natural-height="470">
        <div id="subheader">
            <div id="sub_content">
                <div id="thumb"><img src="img/subway.png" alt=""></div>

                <h1 style="font-family: Buxton Sketch; font-size: 50px; color:white; font-weight: 100;">Subway
                </h1>
                <div style="font-size :18px; color:yellow; "><em>Eat Fresh<em></div>
                <br><br>

                <div style="font-size :15px; color: blanchedalmond;"><i class="icon_pin"></i>Silver Plaza, Shop No. 1, 2, 3, Street Number 7, Patel Colony, Jamnagar, Gujarat 361008</div>
    ...
    <div id="position">
        <div class="container">
            <ul>
              ...
              <li><a href="detail_page.php">Subway</a></li>
            </ul>
		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<div class="dropdown dropdown-options">
						<?php 
                        @$num=0;
						$sql = "select * from tbl_item where rest_Id =7 order by item_Id asc";
